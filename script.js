...
function updateView(currentBtnClassName, currentBtnParentID) {
    ...
    totalPricesObject[currentBtnParentID].innerHTML = totalPricesArray[currentBtnParentID].toFixed(3) + "&nbsp;DT";
}
...
function updateTotalPrice(){
    ...
    document.getElementById("total-Price").innerHTML = " Total : " + totalPrice.toFixed(3) + "&nbsp;DT";
}
